( function ( $ ) {
        ...
        function magnificPopup() {
            ...
            if ( $( ".has-popup1 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup1" ).magnificPopup( option );

            if ( $( ".has-popup2 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup2" ).magnificPopup( option );

            if ( $( ".has-popup3 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup3" ).magnificPopup( option );

            if ( $( ".has-popup4 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup4" ).magnificPopup( option );

            if ( $( ".has-popup5 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup5" ).magnificPopup( option );

            if ( $( ".has-popup6 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup6" ).magnificPopup( option );

            if ( $( ".has-popup7 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup7" ).magnificPopup( option );

            if ( $( ".has-popup8 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup8" ).magnificPopup( option );

            if ( $( ".has-popup9 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup9" ).magnificPopup( option );

            if ( $( ".has-popup10 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup10" ).magnificPopup( option );

            if ( $( ".has-popup11 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup11" ).magnificPopup( option );

            if ( $( ".has-popup12 .pop-up" ).length ) option.delegate = "a.pop-up";
            $( ".has-popup12" ).magnificPopup( option );
        ...
        async function mouseCirMove( $off ) {
            ...
            function cursorEffect() {
                ...
                dsnGrid.elementHover( $elemnet, ".has-popup1 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup2 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup3 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup4 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup5 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup6 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup7 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup8 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup9 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup10 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup11 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
                dsnGrid.elementHover( $elemnet, ".has-popup12 a , .work-item-box a:not(.effect-ajax)", "cursor-scale-half cursor-open" );
